    ...
    override fun onResume() {
        ...
        if (userId != null) {
            lifecycleScope.launch {
                ...
                if (!this@ExerciseActivity1::exerciseDataDocRef.isInitialized) {
                    Toast.makeText(this@ExerciseActivity1, "Could not get activityDataId for this user", Toast.LENGTH_SHORT).show()
                }
            }
        } else {
